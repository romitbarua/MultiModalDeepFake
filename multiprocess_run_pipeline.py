...
def run_pipeline(fake_cols, metadata_path, open_smile_feature_count, run_name_prefix, run_tags, models,
                  create_df_artifact, label_type='label') -> None:
...
def main(experiment_name, open_smile_feature_count, create_df_artifact, num_processes):
    ...
    for run_name_prefix, fake_cols in run_params.items():
        ...
        if len(fake_cols) == 1:
            ...
            args=(fake_cols, metadata_path_unlaundered, open_smile_feature_count, run_name_prefix, run_tags, models, create_df_artifact, 'label')
            task_args.append(args)
        
        #multiclass classification tasks
        else:
            #get args tuple and append to task_args list
            args=(fake_cols, metadata_path_unlaundered, open_smile_feature_count, run_name_prefix, run_tags, models, create_df_artifact, 'multiclass_label')
            task_args.append(args)
    ...
    for run_name_prefix, fake_cols in run_params.items():
        ...
        if len(fake_cols) == 1:
            #get args tuple and append to task_args list
            args=(fake_cols, metadata_path_laundered, open_smile_feature_count, run_name_prefix, run_tags, models, create_df_artifact, 'label')
            task_args.append(args)
        
        #multiclass classification tasks
        else:
            #get args tuple and append to task_args list
            args=(fake_cols, metadata_path_laundered, open_smile_feature_count, run_name_prefix, run_tags, models, create_df_artifact, 'multiclass_label')
            task_args.append(args)
