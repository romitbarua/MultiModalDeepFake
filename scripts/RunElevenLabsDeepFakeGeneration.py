...
def main():
    ...
    file_path = '/Users/romitbarua/Documents/Berkeley/Spring 2023/MultiModalDeepFake/data/wavefake_data/LJ_metadata_testing.csv'
    ...
    deepfake_machine.generateDeepFakeFromDataFrame(file_path, output_dir, source_col, transcript_col, 'QVtynS2YMUZ7VBz3CBed')
